           ...
           # Grab Lut Exported From Zemax
            ...
            if cX != None:
                ...
                if len(otherIndex[0]) > 0:
                    ...
                    # - Light Name/Family
                    cv2.putText(image, "EX-300-WHI", (1150,35), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255,255,255), 2) #Light Part Number
                    cv2.putText(image, "Example Light", (1142,60), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255,255,255), 2) #Light Family(First part of the Part Number) - redundant?
                    # - Date & Time
                    ...
                    # - Pass/Fail data
                    # -- Intensity
                    if flux > intensityLow & flux < intensityHigh:
                        # Flux Passed
                    ...
                    if cY > symmetryLow & cY < symmetryHigh:
                        # Symmetry Passed
                    ...
                    # -- X Value
                    if horiz_length > xLow & horiz_length < xHigh:
                        # X Passed
                    ...
                    # -- Y Value
                    if vert_length > yLow & vert_length < yHigh:
                        # Y Passed
            ...
            # When The Key 'q' is Pressed, Exit the Loop
